...
// zeros
#define COCOAPODS_POD_AVAILABLE_zeros
#define COCOAPODS_VERSION_MAJOR_zeros 0
#define COCOAPODS_VERSION_MINOR_zeros 0
#define COCOAPODS_VERSION_PATCH_zeros 1
